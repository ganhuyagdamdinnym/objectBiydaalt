error id: file:///C:/Users/user/OneDrive/Desktop/objectBiydaalt/LoginGUI.java:java/awt/Dimension#
file:///C:/Users/user/OneDrive/Desktop/objectBiydaalt/LoginGUI.java
empty definition using pc, found symbol in pc: java/awt/Dimension#
...
public class LoginGUI extends JFrame {
    ...
    public LoginGUI(ShopManager shop, ShopGUI shopGUI) {
        ...
        panel.add(loginBtn);
        panel.add(testlabel);
        panel.add(Box.createRigidArea(new Dimensio@@n(0, 5)));
