error id: file:///C:/Users/user/OneDrive/Desktop/obbiydaalt/ShopGUI.java:javax/swing/AbstractButton#addActionListener().
file:///C:/Users/user/OneDrive/Desktop/obbiydaalt/ShopGUI.java
empty definition using pc, found symbol in pc: javax/swing/AbstractButton#addActionListener().
...
public class ShopGUI extends JFrame {
    ...
    public ShopGUI(ShopManager manager) {
        ...
        btnRefresh.addActionLi@@stener(e -> {
            updateTable();
