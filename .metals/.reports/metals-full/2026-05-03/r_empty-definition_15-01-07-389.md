error id: file:///C:/Users/user/OneDrive/Desktop/obbiydaalt/ShopGUI.java:javax/swing/JComponent#setBackground().
...
public class ShopGUI extends JFrame {
    ...
    public ShopGUI(ShopManager manager) {
        ...
        cardPanel.se@@tBackground(new Color(250, 250, 248));
