error id: file:///C:/Users/user/OneDrive/Desktop/obbiydaalt/ShopGUI.java:javax/swing/BorderFactory#createEmptyBorder().
file:///C:/Users/user/OneDrive/Desktop/obbiydaalt/ShopGUI.java
empty definition using pc, found symbol in pc: javax/swing/BorderFactory#createEmptyBorder().
...
public class ShopGUI extends JFrame {
    ...
    public ShopGUI(ShopManager manager) {
        ...
        cardScroll.setBorder(BorderFactory.createEmptyB@@order());
