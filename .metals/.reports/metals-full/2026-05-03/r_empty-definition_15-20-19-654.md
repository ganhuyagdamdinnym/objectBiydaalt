error id: file:///C:/Users/user/OneDrive/Desktop/obbiydaalt/BasketGUI.java:_empty_/ShopManager#getBasketProducts().
file:///C:/Users/user/OneDrive/Desktop/obbiydaalt/BasketGUI.java
empty definition using pc, found symbol in pc: _empty_/ShopManager#getBasketProducts().
...
public class BasketGUI extends JFrame {
    ...
    public BasketGUI(ShopManager shop) {
        ...
        JLabel title = new JLabel("Миний сагсs", SwingConstants.CENTER);
