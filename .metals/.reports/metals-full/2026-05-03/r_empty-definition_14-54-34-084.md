error id: file:///C:/Users/user/OneDrive/Desktop/obbiydaalt/ShopGUI.java:javax/swing/JScrollBar#setUnitIncrement().
file:///C:/Users/user/OneDrive/Desktop/obbiydaalt/ShopGUI.java
empty definition using pc, found symbol in pc: javax/swing/JScrollBar#setUnitIncrement().
...
public class ShopGUI extends JFrame {
    ...
    public ShopGUI(ShopManager manager) {
        ...
        cardScroll.getVerticalScrollBar().setUnitIncr@@ement(16);
