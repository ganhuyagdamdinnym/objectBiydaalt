error id: file:///C:/Users/user/OneDrive/Desktop/obbiydaalt/ShopGUI.java:_empty_/ShopManager#getProducts().
file:///C:/Users/user/OneDrive/Desktop/obbiydaalt/ShopGUI.java
empty definition using pc, found symbol in pc: _empty_/ShopManager#getProducts().
...
public class ShopGUI extends JFrame {
    ...
    private void updateCards(JPanel cardPanel) {
        cardPanel.removeAll();
        for (Product p : manager.getPr@@oducts()) {
